...
void goalAutoRedMORE() {
    ...
    chassis.moveToPoint(22,26, 2000, {.maxSpeed = 70}); //Ring stack
    chassis.waitUntilDone();
    chassis.moveToPoint(18,26, 2000, {.forwards = false, .maxSpeed = 70}); //Ring stack
    ...
    chassis.turnToHeading(35, 2000);
    chassis.moveToPoint(12,16, 2000, {.forwards = false, .maxSpeed = 60}); //Corner
    chassis.waitUntilDone();
    ...
    chassis.waitUntilDone();
    //ladyBrown.move_voltage(12000);  //Move lady brown to touch bar
    //pros::delay(2000);
    //ladyBrown.move_voltage(1000);
}
