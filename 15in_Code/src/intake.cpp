...
void Intake::intake() {
    upper_stage->move_voltage(intake_vel[0]);
    lower_stage->move_voltage(intake_vel[1]);
}
void Intake::outtake() {
    upper_stage->move_voltage(outtake_vel[0]);
    lower_stage->move_voltage(outtake_vel[1]);
}

void Intake::stop() {
    upper_stage->move_voltage(0);
    lower_stage->move_voltage(0);
}
