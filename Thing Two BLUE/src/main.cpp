...
void autonomous() {
	...
	chassis.moveToPoint(28, 74, 2000, {.maxSpeed = 70});    //move away from stake
    chassis.turnToPoint(48, 96, 750); // turn to goal
    chassis.moveToPoint(38, 86, 1000, {.maxSpeed = 70});
    chassis.turnToPoint(120, 0, 500);
    chassis.moveToPoint(6, 138, 2000, {.forwards = false, .maxSpeed = 100});    //Push goal into corner
    chassis.moveToPoint(38, 86, 2000, {.maxSpeed = 100});
	}
